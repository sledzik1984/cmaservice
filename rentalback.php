...
echo "<tr class=\"dark\">\n";
echo "<td class=\"fleftu\">Zwrot</td>\n";
echo "<td class=\"frightu\"></td>\n";
echo "</tr>\n";

echo "<tr class=\"light\">\n";
echo "<td class=\"fleftu\">Kod kreskowy:</td>\n";
echo "<form name=\"rentalback\" id=\"rentalback\" action=\"rentalback.form.php\" method=\"POST\">\n";
echo "<input type=\"submit\" class=\"hiddenbtn\">\n";

echo "<td class=\"frightu\"><input class=\"blend\" type=\"text\" name=\"barcode\" id=\"barcode\" maxlength=\"13\" size=\"13\"><input type=\"hidden\" name=\"rid\" value=\"".$rid."\"></td>\n";
echo "<script type=\"text/javascript\">\n";
echo "document.rentalback.barcode.focus();\n";
echo "</script>\n";
echo "</form>\n";
echo "</tr>\n";
...
echo "<td class=\"frightu\"><img src=\"img/print.gif\"></td>\n";
echo "</tr>\n";
